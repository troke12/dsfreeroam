...
// kyeman 2007, edited by karlip, last edit 10.27.09
//
//-------------------------------------------------
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(strcmp(cmd,"/animlist",true)==0)
	{
	    ...
	    SendClientMessage(playerid,0xAFAFAFAA,"Anim: /handsup /drunk /bomb /getarrested /laugh /lookout /robman");
        SendClientMessage(playerid,0xAFAFAFAA,"Anim: /crossarms /lay /hide /vomit /eat /wave /taichi");
        SendClientMessage(playerid,0xAFAFAFAA,"Anim: /deal /crack /smokem /smokef /groundsit /chat /fucku");
        SendClientMessage(playerid,0xAFAFAFAA,"Special: /handsup /cellin /cellout /beer /wine /sprunk /ciggy /pee /dance");
	}
    ...
    // SIT >> uncomment if you don't have one. ( delete the /* and */ ) <<
